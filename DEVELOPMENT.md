...
| Competition/grant | PASS ask **$32,000**; notarized public artifact; submit packet in `docs/SUBMIT_PACKET.md` | FPF GitHub issue + forum thread (owner-gated public post) |
| License/contribution | PASS **MIT** + `CONTRIBUTING.md` | keep About/site/README license lines in sync |
