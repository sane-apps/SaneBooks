...
- [x] Signed/notarized public artifact with source/dependency/binary provenance — https://dist.zecbooks.app/updates/ZecBooks-0.1.1.zip (Sparkle channel on zecbooks.app; GitHub v0.1.0 lane retired)
